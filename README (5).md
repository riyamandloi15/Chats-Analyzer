...
The project utilizes various open-source libraries and tools. See the [`requirements.txt`](https://github.com/riyamandloi15/Chats-Analyzer/blob/main/requirements.txt) file for details.
